        ...
        try:
            ...
            payload  = {
               "mean_prediction": mean_prediction,
                "mean_prediction_category": reverse_categorize_ndvi( categorize_ndvi(mean_prediction)),

               "max_prediction": max_prediction,
               "max_prediction_category": reverse_categorize_ndvi( categorize_ndvi(max_prediction)),

               "min_prediction": min_prediction,
               "min_prediction_category": reverse_categorize_ndvi( categorize_ndvi(min_prediction)),

               "average":average,
               "average_category": reverse_categorize_ndvi(categorize_ndvi(average))

            }
            return payload
        except Exception as e  : 
            print("NDVI [get_polygon_profile]")
